...
import React, { useEffect, useState } from 'react';
    ...
    const SocialMediaIcons: React.FC = () => {
      return (
        <div className="p-2 flex items-center justify-right">
        <div className="">
          <div>
      
            <div  className="flex flex-wrap justify-center gap-2">
              <a target="_blank" href="https://facebook.com/adentranter" className="bg-blue-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
              ...
              <a target="_blank" href="https://twitter.com/adentranter" className="bg-blue-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
              ...
              <a target="_blank" href="https://reddit.com/u/adentranter" className="bg-red-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
              ...
              <a target="_blank" href="https://www.pinterest.com.au/adentranter/" className="bg-pink-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
              ...
              <a target="_blank" href="https://linkedin.com/adentranter" className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
              ...
              <a target="_blank" href="https://github.com/adentranter" className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
